...
class Clusterer(Node):
    ...
    def callback(self, msg: PointCloud2):
        ...
        """
        suppression du bruit (algo du td)
        un point i est aberrant si ses 2 voisins (i-1 et i+1) sont proches entre eux et i est loin de ces 2 voisins
        """
        ...
        """
        gestion de la discontinuité (premier et dernier point)
        ...
        """
        filtrage par taille de cluster
        """
